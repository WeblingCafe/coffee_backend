...
ENTRYPOINT ["java", "-Dspring.profiles.active=prd", "-Duser.timezone=Asia/Seoul", "-javaagent:/usr/local/pinpoint-agent/pinpoint-bootstrap-2.5.1.jar", "-Dpinpoint.agentId=cf", "-Dpinpoint.applicationName=webling-ip-pinpoint-prd" , "-jar", "/usr/local/coffee.jar"]